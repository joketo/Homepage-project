$(document).ready(function(){
    $(".openWeddingImage").click(function(){
    ...
    $(".openWeddingImages").click(function(){
        wimages = ['CLOTHES/wedding.png','CLOTHES/weddinghem.JPG','CLOTHES/wedding2.JPG'];
        wtitles = ['The wedding dress','',''];
        wdescriptions = ['The green lace makes this wedding dress less traditional.','The hem has pearls and real flowers.','Organza cape made of silk is part of the dress']
